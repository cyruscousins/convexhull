...
public class XKCDColorManager {
	List<Integer> colors;
	List<String> names;
	
	public static void main(String[] args){
		Random rand = new Random();
		XKCDColorManager mngr = new XKCDColorManager();
		for(int i = 0; i < 20; i++){
	...
	public XKCDColorManager(){
		colors = new ArrayList<Integer>(512);
		names = new ArrayList<String>(512);
		
//		//Load database
//		try{
//			BufferedReader reader = new BufferedReader(new FileReader("res/colors.xkcd"));
//
//			while(reader.ready()){
